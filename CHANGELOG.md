...
- fix: isolate split-pane session bindings during server runtime reuse (520f430c)

## [v0.6.19] - 2026-08-20

- fix(app): self-heal cold-start terminal connections in the desktop shell (072ebaa5)

## [v0.6.18] - 2026-08-20

- fix: stop desktop shell from killing external servers, exempt turn commands from 60s timeout (81fa9132)
...
- refactor(server): pass self-spawn intent explicitly, drop PIUI_WORKER_SELF env var (c64b502a)
- fix(server): visible worker crashes, fast fail on hung workers, eager respawn (458cb299)

## [v0.6.10] - 2026-08-18

- fix(worker): never kill busy workers; bounded graceful shutdown (7239e360)
- fix(server): never die abruptly — uncaughtException now shuts down gracefully (97cff143)
