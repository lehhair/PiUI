...
export const PI_COMMAND_SPECS = [
  ...
  { name: "extensionUi.tuiInput", scope: "session", description: "Send raw key input to the extension TUI mirror", paramsSchema: objectSchema({ data: STRING }, ["data"]), queue: "immediate" },
...
export const RUNTIME_TARGETS = {
  ...
  "extensionUi.tuiInput": "extensionTuiInput",
  "extensionUi.tuiResize": "extensionTuiResize",
  "extensionUi.tuiRedraw": "extensionTuiRedraw",
  "state.get": "getState",
