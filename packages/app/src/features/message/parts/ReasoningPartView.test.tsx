...
describe('ReasoningPartView', () => {
  ...
  it('auto-expands while streaming in italic mode', () => {
    const part = {
      ...
      messageID: 'message-1',
      type: 'thinking',
      thinking: 'thinking through steps...',
      time: { start: 1 },
    } as unknown as ThinkingContent

    render(<ReasoningPartView part={part} partKey="test-streaming" isStreaming={true} />)
  ...
  it('renders markdown content in markdown reasoning mode', () => {
    ...
    const part = {
      ...
      messageID: 'message-1',
      type: 'thinking',
      thinking: 'Use **bold** and `code` here',
      time: { start: 1, end: 100 },
    } as unknown as ThinkingContent

    render(<ReasoningPartView part={part} partKey="test-md" isStreaming={false} />)
  ...
  it('renders collapsed markdown preview for multiline content', () => {
    ...
    const part = {
      ...
      messageID: 'message-1',
      type: 'thinking',
      thinking: 'First line with **bold**\nSecond line with `code`',
      time: { start: 1, end: 100 },
    } as unknown as ThinkingContent

    render(<ReasoningPartView part={part} partKey="test-multiline" isStreaming={false} />)
  ...
  it('renders single-line content without toggle button', () => {
    ...
    render(<ReasoningPartView part={part} partKey="test-static" isStreaming={false} />)
